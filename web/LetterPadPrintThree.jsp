<%-- 
    Document   : LetterPad3Print
    Created on : 28 Jul, 2020, 11:33:00 PM
    Author     : winayak
--%>
...
<html>
    <head>
        ...
        <title>MSCElectricals Letter Pad Three Print</title>
        <style>
            body{
                height: auto;
                overflow: auto;
...
To,
     The Deputy Chief Materials Manager (Depot),
     N.F. Railway, New Bongaigaon.


  Sub:- Extension of Delivery  Period  against P.O. No:-NB-17-5191-1-50221 Dt.  29/06/2017.

  Sir,
  	We have the honor to state that we could not supply the materials & COMMISSIONING  THE MATERIAL within stipulated  delivery  period  by  27/07/2017 due  to  Manufacturing  and  Transportation  Problem .
   	So, 
                we therefore request you to kindly extend the D.P. of the above said P.O. No. upto 14-9-2017 without L.D. please. 
