...
<html>
    <head>
        ...
        <title>MSC Electricals GST Bills</title>
        <style>
            ...
            $(document).ready(function(){                
             ...
             $("#save_edit").click(function(){
               ...
               $(document).on("click","#ori_bill",function(){
                    ...
                    var name = $(this).parent().parent().parent().children("td:nth-child(2)").html();
                    $("#dropdown").remove(); 
                    window.open("BillPrint.jsp?offset=0&id="+id+"&type=\'o\'");                    
                });
                $(document).on("click","#dup_bill",function(){
                    var id = $(this).parent().next().val(); 
                    var name = $(this).parent().parent().parent().children("td:nth-child(2)").html();
                    $("#dropdown").remove(); 
                    window.open("BillPrint.jsp?offset=0&id="+id+"&type=\'d\'");                    
                });
                $(document).on("click","#trip_bill",function(){
                    var id = $(this).parent().next().val(); 
                    var name = $(this).parent().parent().parent().children("td:nth-child(2)").html();
                    $("#dropdown").remove(); 
                    window.open("BillPrint.jsp?offset=0&id="+id+"&type=\'t\'");                    
                });
                $(document).on("click","#ori_chall",function(){
                    var id = $(this).parent().next().val(); 
                    var name = $(this).parent().parent().parent().children("td:nth-child(2)").html();
                    $("#dropdown").remove(); 
                    window.open("ChallanPrint.jsp?offset=0&id="+id+"&type=\'o\'");                    
                });
                $(document).on("click","#dup_chall",function(){
                    var id = $(this).parent().next().val(); 
                    var name = $(this).parent().parent().parent().children("td:nth-child(2)").html();
                    $("#dropdown").remove(); 
                    window.open("ChallanPrint.jsp?offset=0&id="+id+"&type=\'d\'");                    
                });
                $(document).on("click","#trip_chall",function(){
                    var id = $(this).parent().next().val(); 
                    var name = $(this).parent().parent().parent().children("td:nth-child(2)").html();
                    $("#dropdown").remove(); 
                    window.open("ChallanPrint.jsp?offset=0&id="+id+"&type=\'t\'");                    
                });
                ...
                <div style="width:1200px;">
                    <table width="100%" border="0">
                        <tr>
                            ...
                            <b align="center" style="font-size:22px;">M/S. MSC ELECTRICALS </b><br />
                                        ...
                                        <td colspan="18" style="padding:0px"><table width="100%" border="0">
                                          <tr>
                                            ...
                                            <td width="33%" valign="top"><p align="center">Certified that the particulars given above are true and correct.</p>
                                              <p align="center"><em>For</em> <strong>M/S MSC ELECTRICALS</strong></p>
