...
<html>
    <head>
        ...
        <title>MSCElectricals Bill Print</title>
        <script>
            $(document).ready(function(){
                    ...
                    $.ajax({
                        ...
                        success:function(list){   
                            if(list!=0){
                                ...
                                $("#after_tax").val(list[0].aftax.toFixed(2));
                                $("#after_tax_display").html(list[0].aftax.toFixed(2));
                                if(list[0].tc==""){
                ...
                $("#page").change(function(){
                    var offset = $(this).val();
                    window.location.replace("BillPrint.jsp?offset="+offset+"&id="+id+"&type=\'o\'");                    
        ...
        <div style="width:1400px;margin:auto">
                    <table width="100%" border="0">
                        <tr>
                            ...
                            <b align="center" style="font-size:22px;"><input type="text" value="M/S. MSC ELECTRICALS" style="    font-size: 22px;text-align: center;font-weight: bold;"> </b><br />
                            <div align="center" style="font-size:18px;"><input type="text" value="Dolaigaon, New Bongaigaon, Dist-Bongaigaon, Assam - 783381" style="    font-size: 18px;text-align: center;"></div>
                            <div align="center" style="margin:5px;font-size:18px;"><strong><input type="text" value="GSTIN: 18ASRPC7468B1ZI/PAN No: ASRPC7468B" style="    font-size: 18px;text-align: center;"> </strong></div>
                            </td>
                             <td width="20%" id="odt">
                                        ...
                                        <td style="border:solid 1px black; border-bottom:none; border-top:none">
                                            <table width="100%" border="0" cellpadding="3">
                                                ...
                                                <tr>
                                                  ...
                                                  <td>GSTIN No </td>
                                                  <td><input type="text"  value="18AAAGM0289C1ZI" required="required" style="font-size: 12px;"></td>
                                      ...
                                      <tr>
                                        ...
                                        <td colspan="18" style="padding:0px"><table width="100%" border="0">
                                          <tr>
                                            ...
                                            <B>
                                                <input type="text" value="PUNJAB NATIONAL BANK"><br />
                                                        <input type="text" value="A/C No: 1201002100019087"><BR />
                                                          <input type="text" value="MICR Code: 783024002"><br />
                                                         <input type="text" value="IFSC Code: PUNB0120100"><BR />
                                                         <input type="text" value="PAN No: ASRPC7468B"><br />
                                            ...
                                            <td width="33%" valign="top"><p align="center">Certified that the particulars given above are true and correct.</p>
                                              <p align="center"><em>For</em> <strong> <input type="text" value="M/S MSC ELECTRICALS" style="text-align:center;">	</strong></p>
