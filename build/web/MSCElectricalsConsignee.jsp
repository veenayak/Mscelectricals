...
<html>
    <head>
        ...
        <title>MSC Electricals Consignee</title>        
        <style>
            .tabs:nth-child(5),.tabs2:nth-child(5){
                ...
                $("#save").click(function(){
                    ...
                    if(flag == 0){
                       $.ajax({
                          type:"Post",
                          url:"BuyerConsignee",
                          data:{item:item,address:address,subtype:"c",type:"add"},
    ...
    <body>
        ...
        <div id="main_div">
            ...
            <div id="search_div">
                <div class="search">
                    <input type="text" placeholder="Enter Consignee Name" id="main_input">
        ...
        <div id="modal">
            <div id="modal_content">
                <h2>New Consignee</h2>
                <input type="text" placeholder="Consignee Name" id="item">
                <input type="text" placeholder="Consignee Address" id="item_address">
        ...
        <div id="modal_edit">
            <div id="modal_content">
                ...
                <input type="text" placeholder="Consignee Name" id="item2">
                <input type="text" placeholder="Consignee Address" id="item2_address">
