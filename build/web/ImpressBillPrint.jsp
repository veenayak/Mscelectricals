...
<html>
    <head>
        ...
        <title>MSCElectricals Impress Bill Print</title>
        <script>
            $(document).ready(function(){
                ...
                $("#page").change(function(){
                    var offset = $(this).val();
                    window.location.replace("ImpressBillPrint.jsp?offset="+offset+"&id="+id+"&type=\'o\'");                    
        ...
        <div style="width:1400px;margin:auto">
                    <table width="100%" border="0">
                        <tr>
                            ...
                            <b align="center" style="font-size:22px;"><input type="text" value="M/S. MSC" style="    font-size: 22px;text-align: center;font-weight: bold;"> </b><br />
                                        ...
                                        <td colspan="18" style="padding:0px"><table width="100%" border="0">
                                          <tr>
                                            ...
                                            <td width="33%" valign="top"><p align="center">Certified that the particulars given above are true and correct.</p>
                                              <p align="center"><em>For</em> <strong> <input type="text" value="M/S MSC" style="text-align:center;">	</strong></p>
