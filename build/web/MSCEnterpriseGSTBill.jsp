...
<html>
    <head>
        ...
        <title>MSC Enterprise GST Bills</title>
        <style>
            ...
            $(document).ready(function(){                
                        ...
                        success:function(obj){
                            ...
                            var total_amt = 0;
                                for(var i = 0; i < list.length; i++) {
                                    ...
                                    before_tax = parseFloat(before_tax)+parseFloat(amt);
                                    total_amt = parseFloat(amt)+parseFloat(total_amt);
                                    total_value = parseFloat(value)+parseFloat(total_value);
                                    
                                    var total = (parseFloat((obj2.rate)*obj2.qty)+value).toFixed(2);  
                                    $("#items_tbody").prepend('<tr class="items">'+
                                        ...
                                        '</td>'+
                                        '<td align="right">'+
                                            '<input type="number" class="tax_value" value='+value.toFixed(2)+' disabled>'+
                                        '</td>'+
                                        
                                        '<td align="right">'+
                                         '   <input type="number" class="cgst_rate" value='+(obj2.tax/2).toFixed(2)+' disabled>'+
                                        '</td>               '+                         
                                        '<td align="right">'+
                                         '   <input type="number" class="cgst_amount" value='+(value/2).toFixed(2)+' disabled>'+
                                        '</td>'+
                                        
                                        '<td align="right">'+
                                        '    <input type="number" class="sgst_rate" value='+(obj2.tax/2).toFixed(2)+' disabled>'+
                                        '</td>'+
                                        '<td align="right">'+
                                        '    <input type="number" class="sgst_amount" value='+(value/2).toFixed(2)+' disabled>'+
                                        '</td>'+
               ...
               $("#save").click(function(){
                ...
                $(document).on("click","#main_content table span",function(){
                     ...
                     $(this).after("<div id=\'dropdown\'><a id=\"edit\"><i class=\"fa fa-edit\"></i></a><a id=\"delete\"><i class=\"fa fa-trash\"></i></a><p>View Bill</p><a id=\"ori_bill\">Original</a><a id=\"dup_bill\">Duplicate</a><a id=\"trip_bill\">Triplicate</a><p>View Challan</p><a id=\"ori_chall\">Original</a><a id=\"dup_chall\">Duplicate</a><a id=\"trip_chall\">Triplicate</a></div>");
                 });                
             ...
             $("#save_edit").click(function(){
               ...
               $(document).on("click","#ori_bill",function(){
                    ...
                    var name = $(this).parent().parent().parent().children("td:nth-child(2)").html();
                    $("#dropdown").remove(); 
                    window.open("EnterpriseBillPrint.jsp?offset=0&id="+id+"&type=\'o\'");                    
                });
                $(document).on("click","#dup_bill",function(){
                    var id = $(this).parent().next().val(); 
                    var name = $(this).parent().parent().parent().children("td:nth-child(2)").html();
                    $("#dropdown").remove(); 
                    window.open("EnterpriseBillPrint.jsp?offset=0&id="+id+"&type=\'d\'");                    
                });
                $(document).on("click","#trip_bill",function(){
                    var id = $(this).parent().next().val(); 
                    var name = $(this).parent().parent().parent().children("td:nth-child(2)").html();
                    $("#dropdown").remove(); 
                    window.open("EnterpriseBillPrint.jsp?offset=0&id="+id+"&type=\'t\'");                    
                });
                $(document).on("click","#ori_chall",function(){
                    var id = $(this).parent().next().val(); 
                    var name = $(this).parent().parent().parent().children("td:nth-child(2)").html();
                    $("#dropdown").remove(); 
                    window.open("EnterpriseChallanPrint.jsp?offset=0&id="+id+"&type=\'o\'");                    
                });
                $(document).on("click","#dup_chall",function(){
                    var id = $(this).parent().next().val(); 
                    var name = $(this).parent().parent().parent().children("td:nth-child(2)").html();
                    $("#dropdown").remove(); 
                    window.open("EnterpriseChallanPrint.jsp?offset=0&id="+id+"&type=\'d\'");                    
                });
                $(document).on("click","#trip_chall",function(){
                    var id = $(this).parent().next().val(); 
                    var name = $(this).parent().parent().parent().children("td:nth-child(2)").html();
                    $("#dropdown").remove(); 
                    window.open("EnterpriseChallanPrint.jsp?offset=0&id="+id+"&type=\'t\'");                    
                });
                ...
                $.ajax({
                   ...
                   success:function(res){
                       if(res!=0){
                           ...
                           $("#po_date").val(obj.date);
                           $("#challan_date").val(obj.date);
                           $("#invoice_date").val(obj.date);
                           console.log(res);
                       }
                       else{
                           alert(res);
    ...
    <body>
        <%@include file="EnterpriseNav.jsp" %>
        <%@include file="EnterpriseSide.jsp" %>
        <div id="main_div">
            <div>
                <h2>GST Bill</h2>
                ...
                <div style="width:1200px;">
                    <table width="100%" border="0">
                        <tr>
                            ...
                            <b align="center" style="font-size:22px;">M/S. MSC ENTERPRISE </b><br />
                                        ...
                                        <td colspan="18" style="padding:0px"><table width="100%" border="0">
                                          <tr>
                                            ...
                                            <td width="33%" valign="top"><p align="center">Certified that the particulars given above are true and correct.</p>
                                              <p align="center"><em>For</em> <strong>M/S MSC ENTERPRISE</strong></p>
