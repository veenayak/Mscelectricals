...
<html>
    <head>
        ...
        <title>MSC Electricals Mode Of Dispatch</title>        
        <style>
            .tabs:nth-child(6),.tabs2:nth-child(6){
                ...
                $("#save_edit").click(function(){                    
                    ...
                    if(flag == 0){
                       $.ajax({
                          type:"Post",
                          url:"ModeOfDispatch",
                          data:{id:id,item:item,type:"update"},
                          success:function(res){
                              if(res==1){
                                  item_display();
                                  $("#modal_edit").hide();
        ...
        <style>
            #main_content tbody tr td:nth-child(3),#main_content thead tr th:nth-child(3){
                text-align: center;
            }
        </style>
    ...
    <body>
        ...
        <div id="main_div">
            <div>
                <h2>Mode Of Dispatch</h2>
                <span id="modal_display">New</span>
            </div>            
            <div id="search_div">
                <div class="search">
                    <input type="text" placeholder="Enter MOD Name" id="main_input">
        ...
        <div id="modal">
            <div id="modal_content">
                <h2>New Mode Of Dispatch</h2>
                <input type="text" placeholder="Mode Of Dispatch" id="item">
        ...
        <div id="modal_edit">
            <div id="modal_content">
                ...
                <input type="text" placeholder="Mode Of Dispatch" id="item2">
