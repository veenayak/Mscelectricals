...
<html>
    <head>
        ...
        <title>MSC Enterprise Challan Print</title>
                        ...
                        success:function(list){   
                            if(list!=0){
                                ...
                                for(var i = 0; i < list[1].length; i++) {
                                    var obj2 = list[1][i];
                                    $("#last").prepend('<tr class="items"  style="color:black; height:30px"><td style="border-bottom:hidden;" align="center">'+length+'</td><td style="border-bottom:hidden;">'+obj2.name+'</td><td style="border-bottom:hidden;" align="center">'+obj2.qty+" "+obj2.uom+'</td></tr>');
                                    length--;
                                }
  ...
  <tr>
    <td height="209"><table width="100%" border="0">
      ...
      <tr>
        <td colspan="3"><div align="center"><span ><input type="text" value="M/s. MSC ENTERPRISE" class="style2" style="text-align:center;">  </span></div></td>
        </tr>
      <tr>
  ...
  <tr>
	...
	<table width="1000" align="center" cellpadding="3">
      ...
      <tr>
        ...
        <td valign="top" style="border-bottom:solid 2px red; border-bottom-style:dotted;color:black;"><select id="po_no" required="required" disabled>
                    <option value=""></option>
              <%
  ...
  <tr>
    <td><table width="100%" border="0">
      ...
      <tr>
        <td>Received By: </td>
        <td><div align="right"><input type="text" value="M/s. MSC ENTERPRISE" style="text-align:right"></div></td>
      </tr>
